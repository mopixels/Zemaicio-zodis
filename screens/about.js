    ...
    <ImageBackground source={require('../img/screen_background.jpg')} style={styles.background}> 
      ...
      : <Text style={styles.text}>Pasiūlīmus, klaidas ė naujus žuodius gal siōstė nurodytās kontaktās</Text> }
        ...
        <View style={styles.row}>
          ...
          <TouchableOpacity onPress={() => Linking.openURL('mailto:dev.mopixels@gmail.com?subject=Žemaičio žodis') }>
            <Text style={styles.text}>dev.mopixels@gmail.com</Text>
          </TouchableOpacity>
          <TouchableOpacity onPress={() => Linking.openURL('https://github.com/mopixels') }>
